<div align=center>
  ...
  <p><em>Remove duplicate lines from text files. CLI with sort, count, and output options.</em></p>
...
```bash
git clone https://github.com/josezuma/remove-duplicates.git && cd remove-duplicates
